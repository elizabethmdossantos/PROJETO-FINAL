CREATE DATABASE  IF NOT EXISTS `sistema_gestao_empresa` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `sistema_gestao_empresa`;
-- MySQL dump 10.13  Distrib 8.0.45, for Win64 (x86_64)
--
-- Host: localhost    Database: sistema_gestao_empresa
-- ------------------------------------------------------
...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '81b9fd69-31eb-11f1-8810-cc96e50265a4:1-110';
...
CREATE TABLE `caixa_diario` (
  ...
  `data_dia` date NOT NULL DEFAULT (curdate()),
...
-- Dump completed on 2026-06-30 14:01:53
